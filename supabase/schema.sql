-- Ruang — Supabase schema Phase 5A
-- Jalankan satu kali melalui Supabase SQL Editor setelah membuat project dan mengaktifkan Auth.
-- Data inti Ruang memakai public.app_state dengan Supabase-first cache; Google Calendar memakai tabel relasional read-only di bagian akhir.
